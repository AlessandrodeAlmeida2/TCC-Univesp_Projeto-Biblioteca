        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <button class="btn-table"><i class="fas fa-eye"></i></button>
                <button class="btn-table"><i class="fas fa-edit"></i></button>
                <button class="btn-table"><i class="fas fa-undo"></i></button>
              </td>
            </tr>
            <tr>
              <td>1000</td>
